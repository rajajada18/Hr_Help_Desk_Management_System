...
AAD//wAA//8AAA==">  <title>Welcome User</title>
...
<link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/fontawesome.css"
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.bundle.min.js"></script>
  <!-- favicon  -->
  <link rel="icon" href="/hr_favicon.ico" type="image/icon ">
<style type="text/css">
...
<nav class="navbar navbar-expand-md default-color navbar-dark fixed-top">
       ...
       <div class="collapse navbar-collapse  " id="collapsibleNavbar ">
        <ul class="navbar-nav ">
            <li class="nav-item  ">
                <a href="/loginPage" class="nav-link text-uppercase ">User Login</a>
            </li>         
    	...
    	<a class="navbar-brand  text-muted" href="#" >Register Page</a>
    </nav>
