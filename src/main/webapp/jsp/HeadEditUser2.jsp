...
<body>
	...
	<jsp:include page="/WEB-INF/header/HrHeadUserNav.jsp"></jsp:include>
		...
		<%if(request.getSession().getAttribute("save")!=""){ %>
${save}
<%} %>
<% request.getSession().setAttribute("save", ""); %>
		<section>
		<form action="/head/save2" method="post" onload="save()">
		<div class="table-responsive-sm container">
		<table  class="table table-hover caption-top table-striped">
		<caption>
			Here you can edit <code>FirstName, LastName, Password</code> but not <span class="text-danger">User-Id, Email </span> of user	data.			
		</caption>
