	...
	<section class="container-flex"
		...
		<div id="demo" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner mt-5" id="slide">
				...
				<a class="btn bg-warning text-dark font-weight-bold btn-lg " href="/hr/view">Resolve a Ticket</a>
				</div>
				<div class="carousel-item">
				<h4>See your tickets...</h4>
				
				<a class="btn bg-warning font-weight-bold text-dark btn-lg " href="/hr/view">View All Tickets 
					<%
					...
					if(count<=0)
						...
						out.print("<span class='badge badge-notification bg-warning text-dark rounded-pill ml-1  p-1'> "+count+"</span>");
					else
				...
				<a href="#" style="font-size: 0.5rem;">
  						<i class="fas fa-envelope fa-5x text-warning font-weight-bold" ></i>
