...
<div class="card " style="width: 18rem;text-align: center;margin: auto;border:2px black solid">
  <img class="card-img-top" src="/jsp/error.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">Something went wrong...</p>
    <a class="btn btn-primary" href="/loginPage">Login here as user</a>
    <a class="btn btn-primary" href="/hr/">Login here as hr</a>
   <a class="btn btn-primary" href="/head/">Login here as hrhead</a> 
  </div>
</div>
